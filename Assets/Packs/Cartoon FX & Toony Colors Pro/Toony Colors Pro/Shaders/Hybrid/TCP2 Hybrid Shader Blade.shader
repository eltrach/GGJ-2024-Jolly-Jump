...
Shader "Toony Colors Pro 2/Hybrid Shader Blade"
{
	Properties
	{
	...
	//# Options
		...
		[ToggleOff(_RECEIVE_SHADOWS_OFF)] _ActivateCutOff("ActivateCutOff",Float)=0
		_RightValue ("RightValue",Float)=0.5
		_LeftValue ("LeftValue",Float)=0.5
	}
